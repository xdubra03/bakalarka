...
\begin{table}[H]
	...
	\begin{tabular}{ | l | c | c | c| }
		\hline 
		Metóda strojového učenia & TP rate & FP rate & Presnosť \\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{ |l | c | c | c | c|}
		\hline 
		Dataset & Stabilizujúce záznamy & Destabilizujúce záznamy & MCC (SVM) & MCC (RF)  \\ \hline
...
Prediktor dosiahol hodnotu korelácie 0,3. Spomedzi testovaných nástrojov predstavuje táto hodnota dobrý výsledok, podobný testovaným. Najlepšie výsledky pri predikcií však dosahujú nástroje založené na využití štatistického alebo fyzického potenciálu, aj keď hodnota MCC nie je najvyššia.
...
Návrhom zlepšenia predikčného nástroja je určite získanie väčšieho množstva relevantných dát, čo ale v~dnešnej dobe nie je jednoduché, pretože databáza ProTherm obsahuje rôzne nedostatky a~dáta nepribúdajú dostatočne rýchlo. 
